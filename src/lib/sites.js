export const sites = {
    ...
    CF: {
      ...
      contactUsBGLeft: "CF_contactUsBGLeft.jpg", //contactUsBGLeft # uses full width background
      contactUsBGRight: "CF_contactUsBGLeft.jpg", //contactUsBGRight # uses full width background
